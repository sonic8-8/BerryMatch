    ...
    return (
        <div className={styles.dashboard_container}>
            ...
            <div className={styles.dashboard_top}>
                ...
                <div className={styles.dashboard_top_user_container}>
            ...
            <div className={styles.dashboard_middle}>
                ...
                <div className={styles.dashboard_middle_right}>
                    <div className={styles.dashboard_middle_right_menu_container}>
                        <div className={styles.dashboard_middle_right_menu_large}>
                            <MatchStatus/>
                            <MatchSetupSubPage />
                        </div>
                    </div>
                    <div className={styles.dashboard_middle_right_menu_container}>
                        <Link to="/rank" className={styles.dashboard_middle_right_menu_small}>랭킹</Link>
                        <Link to="/board" className={styles.dashboard_middle_right_menu_small}>하이라이트</Link>
                    </div>
                    <div className={styles.dashboard_middle_right_menu_container}>
                        <Link to="/guild" className={styles.dashboard_middle_right_menu_large}>길드</Link>
